...
def upgrade() -> None:
    ...
    op.create_index('ix_alert_destination_project', 'alert_destinations', ['project_id'], unique=False)
    ...
    op.create_index('ix_plan_revisions_project_created', 'plan_revisions', ['project_id', 'created_at'], unique=False)
    op.create_table('project_anomaly_settings',
    sa.Column('project_id', sa.Uuid(), nullable=False),
    ...
    op.create_table('alert_rule_filters',
    ...
    op.create_table('event_metric_breakdowns',
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('scan_config_id', 'event_id', 'bucket', 'breakdown_column', 'breakdown_value', 'is_other', name='uq_event_metric_breakdown_config_event_bucket_value'),
    sa.UniqueConstraint('scan_config_id', 'event_type_id', 'bucket', 'breakdown_column', 'breakdown_value', 'is_other', name='uq_event_metric_breakdown_config_type_bucket_value')
    )
    op.create_index('ix_event_metric_breakdown_config_column_bucket', 'event_metric_breakdowns', ['scan_config_id', 'breakdown_column', 'bucket'], unique=False)
    op.create_index('ix_event_metric_breakdown_event_bucket', 'event_metric_breakdowns', ['event_id', 'breakdown_column', 'bucket'], unique=False)
    op.create_index('ix_event_metric_breakdown_type_bucket', 'event_metric_breakdowns', ['event_type_id', 'breakdown_column', 'bucket'], unique=False)
    ...
    op.create_index('ix_event_metric_event_bucket', 'event_metrics', ['event_id', 'bucket'], unique=False)
    op.create_index('ix_event_metric_type_bucket', 'event_metrics', ['event_type_id', 'bucket'], unique=False)
    ...
    op.create_index('ix_event_photo_event_order', 'event_photos', ['event_id', 'sort_order'], unique=False)
    ...
    sa.ForeignKeyConstraint(['scan_config_id'], ['scan_configs.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('scan_config_id', 'scope_type', 'scope_ref', 'bucket', name='uq_metric_anomaly_scope_bucket')
    )
    op.create_index('ix_metric_anomaly_event_bucket', 'metric_anomalies', ['event_id', 'bucket'], unique=False)
    op.create_index('ix_metric_anomaly_scope_bucket', 'metric_anomalies', ['scan_config_id', 'scope_type', 'scope_ref', 'bucket'], unique=False)
    op.create_index('ix_metric_anomaly_type_bucket', 'metric_anomalies', ['event_type_id', 'bucket'], unique=False)
    op.create_table('metric_breakdown_anomalies',
    sa.Column('scan_config_id', sa.Uuid(), nullable=False),
    sa.Column('scope_type', sa.String(length=32), nullable=False),
    sa.Column('scope_ref', sa.String(length=64), nullable=False),
    sa.Column('event_id', sa.Uuid(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['scan_config_id'], ['scan_configs.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('scan_config_id', 'scope_type', 'scope_ref', 'breakdown_column', 'breakdown_value', 'is_other', 'bucket', name='uq_metric_breakdown_anomaly_scope_bucket_value')
    )
    op.create_index('ix_metric_breakdown_anomaly_event_bucket', 'metric_breakdown_anomalies', ['event_id', 'breakdown_column', 'bucket'], unique=False)
    op.create_index('ix_metric_breakdown_anomaly_scope_bucket', 'metric_breakdown_anomalies', ['scan_config_id', 'scope_type', 'scope_ref', 'breakdown_column', 'breakdown_value', 'is_other', 'bucket'], unique=False)
    op.create_index('ix_metric_breakdown_anomaly_type_bucket', 'metric_breakdown_anomalies', ['event_type_id', 'breakdown_column', 'bucket'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('event_type_id', 'field_name', 'drift_type', name='uq_schema_drift_event_type_field_kind')
    )
    op.create_index('ix_schema_drift_event_type_detected', 'schema_drifts', ['event_type_id', 'detected_at'], unique=False)
    ...
    op.create_index('ix_alert_delivery_destination_created', 'alert_deliveries', ['destination_id', 'created_at'], unique=False)
    op.create_index('ix_alert_delivery_project_created', 'alert_deliveries', ['project_id', 'created_at'], unique=False)
    op.create_index('ix_alert_delivery_rule_created', 'alert_deliveries', ['rule_id', 'created_at'], unique=False)
    op.create_index('ix_alert_delivery_scan_created', 'alert_deliveries', ['scan_config_id', 'created_at'], unique=False)
    op.create_table('alert_delivery_items',
    ...
    op.create_index('ix_alert_delivery_item_delivery', 'alert_delivery_items', ['delivery_id'], unique=False)
    op.create_table('alert_rule_states',
    sa.Column('rule_id', sa.Uuid(), nullable=False),
    sa.Column('scan_config_id', sa.Uuid(), nullable=False),
    sa.Column('scope_type', sa.String(length=32), nullable=False),
    sa.Column('scope_ref', sa.String(length=64), nullable=False),
    ...
    op.create_index('ix_alert_rule_state_scan', 'alert_rule_states', ['scan_config_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_metric_breakdown_anomaly_type_bucket', table_name='metric_breakdown_anomalies')
    op.drop_index('ix_metric_breakdown_anomaly_scope_bucket', table_name='metric_breakdown_anomalies')
    op.drop_index('ix_metric_breakdown_anomaly_event_bucket', table_name='metric_breakdown_anomalies')
    ...
    op.drop_index('ix_event_metric_breakdown_config_column_bucket', table_name='event_metric_breakdowns')
