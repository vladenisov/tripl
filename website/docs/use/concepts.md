...
later catalog run — a manual scan or a scheduled collection, since both create
variables; one a person edited, documented, or excluded from scans is kept. See
